...
#define SLEN 200000
// this version output the arrival time of amplitude peak of filtered time series. 
// output one more parameter than V2 doese. 
...
/*--------------------------------------------------------------*/
{
  ...
  double minP= 4.0  ;
  double per[nf],f[nf],snr[nf],Ttime[nf];
